...
khab_path <- "\\koala_habitat\\koala_habitat"

# Mac
rdm_path <- "smb://shares01.rdm.uq.edu.au/KPRIVATE19-A2212/data"
suitability_path <- "/Graham_et_al_2019_koalas/Phascolarctos_cinereus/species_data_Phascolarctos_cinereus/suitability/"
properties_path <- "/spatial_bid_model_predictions/version_1_1/spatial_predictions_v1_1.gdb"
khab_path <- "/koala_habitat/koala_habitat.ovr"
